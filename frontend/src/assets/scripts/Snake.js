...
export class Snake extends GameObject {
  constructor(info, gamemap) {
    ...
    this.cells = [new Cell(info.r, info.c)]; // store the body of a snake
    this.next_cell = null;

    this.speed = 5; // 5 grids per second
    this.direction = -1; // -1: no action. 0,1,2,3: up,right,down,left
    this.status = "idle";
  ...
  check_tail_increasing() {
    // check whether the length of snakes increases.
